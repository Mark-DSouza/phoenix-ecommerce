defmodule Hello.CatalogTest do
  ...
  describe "products" do
    ...
    @invalid_attrs %{title: nil, descripton: nil, price: nil, views: nil}
    ...
    test "create_product/1 with valid data creates a product" do
      valid_attrs = %{title: "some title", descripton: "some descripton", price: "120.5", views: 42}

      assert {:ok, %Product{} = product} = Catalog.create_product(valid_attrs)
      assert product.title == "some title"
      assert product.descripton == "some descripton"
    ...
    test "update_product/2 with valid data updates the product" do
      product = product_fixture()
      update_attrs = %{title: "some updated title", descripton: "some updated descripton", price: "456.7", views: 43}

      assert {:ok, %Product{} = product} = Catalog.update_product(product, update_attrs)
      assert product.title == "some updated title"
      assert product.descripton == "some updated descripton"
